...
enum L {
    ...
    static let personalSaveAndShareCategorySection = "personal.saveAndShare.categorySection"
    static let personalSaveAndShareCategoryLabel = "personal.saveAndShare.categoryLabel"
    static let personalSaveAndShareCategoryHint = "personal.saveAndShare.categoryHint"
    ...
    static let personalCategoryManagerTitle = "personal.category.managerTitle"
    static let personalCategoryExpense = "personal.category.expense"
    static let personalCategoryIncome = "personal.category.income"
    static let personalCategoryFee = "personal.category.fee"
    static let personalCategoryAdd = "personal.category.add"
    static let personalCategoryAddExpense = "personal.category.add.expense"
    static let personalCategoryAddIncome = "personal.category.add.income"
    static let personalCategoryAddFee = "personal.category.add.fee"
    static let personalCategoryEditTitle = "personal.category.edit"
    static let personalCategoryEmpty = "personal.category.empty"
    static let personalCategorySystemBadge = "personal.category.badge.system"
    static let personalCategoryHiddenBadge = "personal.category.badge.hidden"
    static let personalCategoryShow = "personal.category.show"
    static let personalCategoryHide = "personal.category.hide"
    static let personalCategoryNameField = "personal.category.field.name"
    static let personalCategoryIconField = "personal.category.field.icon"
    static let personalCategoryColorField = "personal.category.field.color"
    static let personalCategoryColorDefault = "personal.category.color.default"
    static let personalCategorySystemLock = "personal.category.system.locked"
    static let personalCategoryErrorTitle = "personal.category.errorTitle"
    static let personalCategoryHideError = "personal.category.hideError"
    static let personalCategoryIconGeneric = "personal.category.icon.generic"
    static let personalCategoryIconFood = "personal.category.icon.food"
    static let personalCategoryIconDrinks = "personal.category.icon.drinks"
    static let personalCategoryIconShopping = "personal.category.icon.shopping"
    static let personalCategoryIconGroceries = "personal.category.icon.groceries"
    static let personalCategoryIconBills = "personal.category.icon.bills"
    static let personalCategoryIconHousing = "personal.category.icon.housing"
    static let personalCategoryIconTransport = "personal.category.icon.transport"
    static let personalCategoryIconTravel = "personal.category.icon.travel"
    static let personalCategoryIconUtilities = "personal.category.icon.utilities"
    static let personalCategoryIconEntertainment = "personal.category.icon.entertainment"
    static let personalCategoryIconClothing = "personal.category.icon.clothing"
    static let personalCategoryIconMedical = "personal.category.icon.medical"
    static let personalCategoryIconWellness = "personal.category.icon.wellness"
    static let personalCategoryIconGift = "personal.category.icon.gift"
    static let personalCategoryIconCelebration = "personal.category.icon.celebration"
    static let personalCategoryIconEducation = "personal.category.icon.education"
    static let personalCategoryIconGrowth = "personal.category.icon.growth"
    static let personalCategoryIconInvestment = "personal.category.icon.investment"
    static let personalCategoryIconCulture = "personal.category.icon.culture"
    static let personalCategoryIconMusic = "personal.category.icon.music"
    static let personalCategoryIconPhotography = "personal.category.icon.photography"
    static let personalCategoryIconBooks = "personal.category.icon.books"
    static let personalCategoryIconLifestyle = "personal.category.icon.lifestyle"
    static let personalCategoryIconPet = "personal.category.icon.pet"
    static let personalCategoryIconNightlife = "personal.category.icon.nightlife"
    static let personalCategoryIconTransit = "personal.category.icon.transit"
    static let personalCategoryIconSports = "personal.category.icon.sports"
    static let personalCategoryIconFitness = "personal.category.icon.fitness"
    ...
    static let personalStatsGroupsTitle = "personal.stats.groups.title"
    static let personalStatsGroupsManage = "personal.stats.groups.manage"
    static let personalStatsGroupsUngrouped = "personal.stats.groups.ungrouped"
    static let personalStatsGroupsEmpty = "personal.stats.groups.empty"
    static let personalStatsGroupsCreate = "personal.stats.groups.create"
    static let personalStatsGroupsEdit = "personal.stats.groups.edit"
    static let personalStatsGroupsName = "personal.stats.groups.name"
    static let personalStatsGroupsColor = "personal.stats.groups.color"
    static let personalStatsGroupsClearColor = "personal.stats.groups.clearColor"
    static let personalStatsGroupsCategories = "personal.stats.groups.categories"
    static let personalStatsGroupsNoCategory = "personal.stats.groups.noCategory"
    static let personalStatsGroupsRole = "personal.stats.groups.role"
    static let personalStatsGroupsRoleCustom = "personal.stats.groups.role.custom"
    static let personalStatsGroupsRoleEssential = "personal.stats.groups.role.essential"
    static let personalStatsGroupsRoleDiscretionary = "personal.stats.groups.role.discretionary"
    static let personalStatsGroupsCategoryCount = "personal.stats.groups.categoryCount"
    static let personalStatsManager = "personal.stats.manager"
