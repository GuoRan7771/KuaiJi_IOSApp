...
### V4.51(8) – 界面重构与功能整合
- **界面与导航**：朋友标签页移至共享账本页，切换更便捷；重做统计分析页面；优化首次启动UI。
- **分类管理**：支持修改系统分类颜色及隐藏分类；自定义图标支持更多 SF 符号。
- **模版功能**：新增个人账本模版，支持创建/排序/一键套用，并包含在备份中。
- **归档功能**：共享账本支持归档（右滑操作）；列表分为“最近更新”与“已归档”。
- **备份与优化**：备份包含分类设置与模版；新增桌面长按快捷入口；增加删除确认弹窗。
